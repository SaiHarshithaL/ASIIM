...
if(isset($_POST['submit']))
{
	...
	$sql_query="INSERT INTO prototype(username,title,theme,descs,submission)values('$username','$title','$theme','$descs','$video')";
	$sql_query1="INSERT INTO dumprototype(username,title,theme,descs,submission)values('$username','$title','$theme','$descs','$video')";
		}
	else{
