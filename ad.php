...
<br><br>
    <section>
    <iframe src="admindash.html" width="22%" height="850px" align="left" > 
      </iframe>
      <iframe name="main_page" width="78%" height="850px" align="right" src="dash.php">
   ...
   <section>
    <br><br><br>
    <br><br><br>
    <center><H2 STYLE="color:pink;">END OF ADMIN PORTAL</H2></center>
    <br><br>
    <hr>
