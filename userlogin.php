...
$sql_query="SELECT * from dumprototype where username='$mymail'";
...
{
  $sql="SELECT uids from cap where username='$mymail'";
  $rr3=mysqli_query($conn,$sql);
  $rf3=mysqli_fetch_array($rr3);
  $uid=$rf3["uids"];
	...
	$sql_query="INSERT INTO prototype(uids,username,title,theme,descs,submission)values('$uid','$username','$title','$theme','$descs','$submission')";
	$sql_query1="INSERT INTO dumprototype(uids,username,title,theme,descs,submission)values('$uid','$username','$title','$theme','$descs','$submission')";
		}
	else{
...
<div ><br><br><br></div>
    <section>
        <center><h2 class="glow"><bold>IDEA PROTOTYPE SUBMISSSION<br><br></bold></h2>
