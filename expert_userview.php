    ...
    <section>
      <form action="" method="post"  enctype="multipart/form-data"><center>
        <table>
            ...
            <tr>
              <td><label for="title"><h2 style="color:crimson;">USIDS</h2></label>
        ...
        <table>
          ...
          die("connection failed:".mysqli_connect_error());
                ...
                {
                    $uids=$_POST['uids'];
                   $sql_query1="SELECT * FROM prototype where uids='$uids'";
	                $result1=mysqli_query($conn,$sql_query1);
                    ...
                    <tr style="text-align:center">
                                  <td><h3 >SUBMISSION</h3></td>
                                    <td>
                                      <a href="files.pdf/<?php echo $row1['submission']?>" target="_blank">
                                        view
                                      </a>
                                  </td>
                                </tr>
                                <tr style="text-align:center">
                                  <td colspan="2">
                                  <iframe src="files.pdf/<?php echo $row1['submission']?>" style="width:900px; height:450px;"></iframe>
                    </td>
                    </tr>
                    <tr>
...
?>
          ...
          <?php
              ...
              {
	            $uids=$_POST['uids'];
	            $username1="SELECT * FROM prototype where uids=$uids and theme='$theme'";
            ...
            <br><br>
              ...
              $u=$row3["theme"];
              $v=$row3["descs"];
	            $sql_query1="INSERT INTO lap(uids,username,title,theme,descs,exmail)values('$x','$y','$z','$u','$v','$mail')";
              $sql_query3="DELETE from prototype where uids='$x'";
	            function checkprimary($conn,$sql_query1,$sql_query3) {
              ...
              try {
                checkprimary($conn,$sql_query1,$sql_query3);
                echo "";
...
?>
   <?php
        ...
        <br><br>
          ...
          $u=$row3["theme"];
          $v=$row3["descs"];
          $sql_query1="INSERT INTO lar(uids,username,title,theme,descs,exmail)values('$x','$y','$z','$u','$v','$mail')";
          $sql_query3="DELETE from prototype where uids='$x'";
          function checkprimary($conn,$sql_query1,$sql_query3) {
            if(mysqli_query($conn,$sql_query1)) {
              if(mysqli_query($conn,$sql_query3)) {
